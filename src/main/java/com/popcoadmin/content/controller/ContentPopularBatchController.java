...
public class ContentPopularBatchController {
    ...
    private final BatchFailureLogServiceImpl batchFailureLogServiceImpl;
    ...
    public ResponseEntity<List<BatchFailureLog>> getUnprocessedFailures() {
        List<BatchFailureLog> failures = batchFailureLogServiceImpl.getUnprocessedFailures();
    ...
    public ResponseEntity<String> markAsProcessed(@PathVariable Long failureLogId) {
        batchFailureLogServiceImpl.markAsProcessed(failureLogId);
    ...
    public ResponseEntity<List<BatchFailureLog>> getFailuresByJobAndStep(
        ...
        List<BatchFailureLog> failures = batchFailureLogServiceImpl.getFailuresByJobAndStep(jobName, stepName);
        return ResponseEntity.ok(failures);
    }
}
